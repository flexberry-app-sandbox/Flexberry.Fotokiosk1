...
namespace IIS.Fotokiosk1
{
    ...
    [View("СделатьФотоE", new string[] {
            ...
            "ИнфоФото.Категория as \'Категория\'"}, Hidden=new string[] {
            "ИнфоФото.Категория"})]
    ...
    public class СделатьФото : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СделатьФотоE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СделатьФотоE", typeof(IIS.Fotokiosk1.СделатьФото));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СделатьФотоL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СделатьФотоL", typeof(IIS.Fotokiosk1.СделатьФото));
                }
            }
        }
    }
