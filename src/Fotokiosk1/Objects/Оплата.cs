...
namespace IIS.Fotokiosk1
{
    ...
    [View("ОплатаE", new string[] {
            ...
            "Дата as \'Дата\'",
            "Время as \'Время\'",
            "СделатьФото as \'Сделать фото\'",
            "СделатьФото.КолВоФото as \'Кол во фото\'"}, Hidden=new string[] {
            "СделатьФото.КолВоФото"})]
    [MasterViewDefineAttribute("ОплатаE", "СделатьФото", ICSSoft.STORMNET.LookupTypeEnum.Standard, "", "КолВоФото")]
    [View("ОплатаL", new string[] {
            ...
            "Дата as \'Дата\'",
            "Время as \'Время\'",
            "СделатьФото.КолВоФото as \'Кол во фото\'"})]
    public class Оплата : ICSSoft.STORMNET.DataObject
    {
        
        private int fId;
        
        private IIS.Fotokiosk1.ВидОплаты fВидОплаты;
        ...
        private IIS.Fotokiosk1.СделатьФото fСделатьФото;
        ...
        /// Id.
        /// </summary>
        // *** Start programmer edit section *** (Оплата.Id CustomAttributes)

        // *** End programmer edit section *** (Оплата.Id CustomAttributes)
        public virtual int Id
        {
            get
            {
                // *** Start programmer edit section *** (Оплата.Id Get start)

                // *** End programmer edit section *** (Оплата.Id Get start)
                int result = this.fId;
                // *** Start programmer edit section *** (Оплата.Id Get end)

                // *** End programmer edit section *** (Оплата.Id Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (Оплата.Id Set start)

                // *** End programmer edit section *** (Оплата.Id Set start)
                this.fId = value;
                // *** Start programmer edit section *** (Оплата.Id Set end)

                // *** End programmer edit section *** (Оплата.Id Set end)
            }
        }
        ...
        public virtual IIS.Fotokiosk1.ВидОплаты ВидОплаты
        {
            get
            {
                ...
                IIS.Fotokiosk1.ВидОплаты result = this.fВидОплаты;
        ...
        [PropertyStorage(new string[] {
                "СделатьФото"})]
        [NotNull()]
        public virtual IIS.Fotokiosk1.СделатьФото СделатьФото
        {
            get
            {
                ...
                IIS.Fotokiosk1.СделатьФото result = this.fСделатьФото;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ОплатаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОплатаE", typeof(IIS.Fotokiosk1.Оплата));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ОплатаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОплатаL", typeof(IIS.Fotokiosk1.Оплата));
                }
            }
        }
    }
