...
namespace IIS.Fotokiosk1
{
    ...
    public class ДопНастройки : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Fotokiosk1.ИнфоФото fИнфоФото;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Fotokiosk1.ИнфоФото.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "ИнфоФото"})]
        public virtual IIS.Fotokiosk1.ИнфоФото ИнфоФото
        {
            get
            {
                ...
                IIS.Fotokiosk1.ИнфоФото result = this.fИнфоФото;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДопНастройкиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДопНастройкиE", typeof(IIS.Fotokiosk1.ДопНастройки));
                }
            }
        }
    }
    ...
    public class DetailArrayOfДопНастройки : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Fotokiosk1.DetailArrayOfДопНастройки members)

        // *** End programmer edit section *** (IIS.Fotokiosk1.DetailArrayOfДопНастройки members)
        ...
        /// </summary>
        public DetailArrayOfДопНастройки(IIS.Fotokiosk1.ИнфоФото fИнфоФото) : 
                base(typeof(ДопНастройки), ((ICSSoft.STORMNET.DataObject)(fИнфоФото)))
        {
        }
        
        public IIS.Fotokiosk1.ДопНастройки this[int index]
        {
            get
            {
                return ((IIS.Fotokiosk1.ДопНастройки)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Fotokiosk1.ДопНастройки dataobject)
        {
